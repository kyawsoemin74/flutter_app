...
class RecentMatchPage extends StatefulWidget {
  final int leagueid;
  final int season;
  const RecentMatchPage(
      {Key? key, required this.leagueid, required this.season})
      : super(key: key);

  @override
  State<RecentMatchPage> createState() => _RecentMatchPageState();
}

class _RecentMatchPageState extends State<RecentMatchPage> {
 ...
 InterstitialAd? _interstitialAd;
  ...
  Widget build(BuildContext context) {
    ...
    var recentleague = livematch.leaguefixture
        .where((element) => element.fixture!.status!.long == "Match Finished")
        .toList();
    recentleague
