...
List<Singlefixture> singlefixtureFromJson(String str) =>
    List<Singlefixture>.from(
        json.decode(str).map((x) => Singlefixture.fromJson(x)));

String singlefixtureToJson(List<Singlefixture> data) =>
...
class Singlefixture {
  ...
  factory Singlefixture.fromJson(Map<String, dynamic> json) => Singlefixture(
        ...
        lineups:
            List<Lineups>.from(json["lineups"].map((x) => Lineups.fromJson(x))),
        statistics: List<SinglefixtureStatistic>.from(
            json["statistics"].map((x) => SinglefixtureStatistic.fromJson(x))),
        players: List<SinglefixturePlayer>.from(
            json["players"].map((x) => SinglefixturePlayer.fromJson(x))),
      );
...
class SinglefixturePlayer {
  ...
  factory SinglefixturePlayer.fromJson(Map<String, dynamic> json) =>
      SinglefixturePlayer(
        team: Team.fromJson(json["team"]),
        players: List<PlayerPlayer>.from(
            json["players"].map((x) => PlayerPlayer.fromJson(x))),
      );
...
class SinglefixtureStatistic {
  ...
  factory SinglefixtureStatistic.fromJson(Map<String, dynamic> json) =>
      SinglefixtureStatistic(
        team: Team.fromJson(json["team"]),
...
class StatisticStatistic {
  ...
  factory StatisticStatistic.fromJson(Map<String, dynamic> json) =>
      StatisticStatistic(
        type: json["type"],
        value: json["value"] == null ? "0" : json["value"].toString(),
      );
